...
Em ambos os formatos, os tópicos estruturais devem estar presentes (introdução, referencial, justificativa, problema, etc...) porém de formas diferentes devido ao foco de apresentação final do texto. 
...
Ter compromisso, atenção aos prazos e entregas, boa comunicação (com educação) e disposição à pesquisa, são ingredientes que contribuiem para um bom trabalho. 
