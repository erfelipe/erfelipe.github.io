...
<h5> Fluxogramas, esquemas gráficos </h5>
...
<ul>
  ...
  <li><b>Atenção</b> - <i>"Não existe almoço grátis"</i>. Não acesse esses serviços com um browser comum e/ou ainda use seu email principal como cadastro (se necessário). </li>
...
<ol>
  ...
  <ul><li>Solicitar o orientador(a) que cadastre o início do projeto na <a href="https://www.gov.br/pt-br/servicos/submeter-na-plataforma-brasil-de-projetos-de-pesquisa-envolvendo-seres-humanos-para-avaliacao-etica" target="_blank">plataforma Brasil </a>e colocar você (discente) com autonomia para preencher os dados da plataforma</li></ul>
