...
Uma atualização necessária para evitar constrangimentos, é ter o entendimento que o trabalho acadêmico mesmo sendo escrito pelo(a) discente, tem também como autoria o(a) orientador(a). Portanto, ao elencar o nome no template escolhido, o(a) orientador(a) também participa do trabalho e é de bom tom perguntar qual a forma deve ser usada no trabalho (extenso, abreviação). O mesmo raciocínio é válido para comunicações a respeito do trabalho. Se há um questionário a ser enviado por causa da pesquisa, no texto deve constar o pesquisador(a) discente e a referência ao orientador. É uma questão de respeito, bom senso, gratidão, enfim... são valores que trago comigo das minhas orientações passadas e que agora nesta geração, de forma surpreendente, preciso tornar isso explícito. 
